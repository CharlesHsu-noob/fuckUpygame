...
while running:
    ...
    # 🔦 畫手電筒在入口
    flashlight_rect = flashlight_img.get_rect(center=entry_rect.center)
    ...
    pg.draw.rect(screen, GRAY, restart_button)
    screen.blit(font.render("start", True, BLACK), (start_button.x+20, start_button.y+5))
    screen.blit(font.render("try again", True, BLACK), (restart_button.x+20, restart_button.y+5))
